<div class="container-fluid bg-white mt-5 shadow">
  <div class="row">
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="rooms.php" class="d-inline-block mb-2 text-dark text-decoration-none"><i class="bi bi-building-fill"></i> Rooms</a> <br>
...
<script>
  function alert(type,msg,position='body'){
      ...
      element.innerHTML = `
          <div class="alert ${bs_class} alert-dismissable fade show" role="alert">
    ...
    register_form.addEventListener('submit', (e)=>{
      ...
      xhr.onload = function(){
        if(this.responseText == 'pass_mismatch'){
          ...
          alert('success', "Registration successfull. Confirmation link sent to email!");
          register_form.reset();
        }
      }
      xhr.send(data);
